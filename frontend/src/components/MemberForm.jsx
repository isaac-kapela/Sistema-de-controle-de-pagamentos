...
const s = {
  ...
  header: {
    ...
    padding: 'clamp(14px, 2vw, 20px) clamp(14px, 3vw, 24px)',
  ...
  title: { fontSize: 'clamp(15px, 3vw, 18px)', fontWeight: 700 },
  closeBtn: {
    background: 'transparent', color: 'var(--text-muted)',
    fontSize: 18, padding: '4px 8px', borderRadius: 6, flexShrink: 0,
  },
  body: { padding: 'clamp(0px, 0vw, 0px) clamp(14px, 3vw, 24px) clamp(14px, 3vw, 24px)', overflowY: 'auto' },
  ...
  tipoOptions: { display: 'flex', gap: 12, flexWrap: 'wrap' },
  tipoBtn: {
